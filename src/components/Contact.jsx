    ...
    <section id="contact" className="reveal py-32 px-6">
      ...
      <div className="max-w-6xl mx-auto bg-zinc-950/40 border border-amber-500/10 rounded-3xl p-8 md:p-12 backdrop-blur-xl shadow-[0_0_50px_rgba(245,158,11,0.15)] flex flex-col lg:flex-row lg:items-center justify-between gap-12">
        ...
        <div className="w-full lg:w-[45%] flex flex-col items-center justify-center text-center lg:-translate-y-4">
          ...
          <div className="relative w-76 h-76 md:w-[340px] md:h-[340px] mx-auto flex items-center justify-center select-none">
            
            {/* Dashed Connecting Lines SVG */}
            <svg className="absolute inset-0 w-full h-full pointer-events-none" viewBox="0 0 100 100">
              <line x1="50" y1="50" x2="12" y2="14" stroke="rgba(245,158,11,0.22)" strokeWidth="1" strokeDasharray="3 3" />
              <line x1="50" y1="50" x2="88" y2="14" stroke="rgba(245,158,11,0.22)" strokeWidth="1" strokeDasharray="3 3" />
              <line x1="50" y1="50" x2="4" y2="50" stroke="rgba(245,158,11,0.22)" strokeWidth="1" strokeDasharray="3 3" />
              <line x1="50" y1="50" x2="96" y2="50" stroke="rgba(245,158,11,0.22)" strokeWidth="1" strokeDasharray="3 3" />
              <line x1="50" y1="50" x2="12" y2="86" stroke="rgba(245,158,11,0.22)" strokeWidth="1" strokeDasharray="3 3" />
              <line x1="50" y1="50" x2="88" y2="86" stroke="rgba(245,158,11,0.22)" strokeWidth="1" strokeDasharray="3 3" />
            </svg>
            ...
            <div className="absolute top-[23%] left-[20%] text-amber-400 animate-pulse text-lg">&#x2728;</div>
            <div className="absolute bottom-[23%] right-[20%] text-amber-400 animate-pulse text-lg delay-700">&#x2728;</div>

            {/* Floating Clickable Icons */}
            {/* Phone */}
            <a
              href="tel:+918500156156"
              className="absolute top-[6%] left-[4%] z-20 flex items-center justify-center w-12 h-12 rounded-full bg-zinc-900 border border-amber-500/40 text-amber-400 shadow-[0_0_15px_rgba(245,158,11,0.3)] hover:shadow-[0_0_25px_rgba(245,158,11,0.6)] hover:scale-110 hover:-translate-y-1 hover:text-white transition-all duration-300 animate-float-icon group"
            >
            ...
            <a
              ...
              className="absolute top-[6%] right-[4%] z-20 flex items-center justify-center w-12 h-12 rounded-full bg-zinc-900 border border-amber-500/40 text-amber-400 shadow-[0_0_15px_rgba(245,158,11,0.3)] hover:shadow-[0_0_25px_rgba(245,158,11,0.6)] hover:scale-110 hover:-translate-y-1 hover:text-white transition-all duration-300 animate-float-icon-slow group"
            >
            ...
            <a
              ...
              className="absolute top-[44%] left-[-4%] z-20 flex items-center justify-center w-12 h-12 rounded-full bg-zinc-900 border border-amber-500/40 text-amber-400 shadow-[0_0_15px_rgba(245,158,11,0.3)] hover:shadow-[0_0_25px_rgba(245,158,11,0.6)] hover:scale-110 hover:-translate-y-1 hover:text-white transition-all duration-300 animate-float-icon group"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="absolute top-[44%] right-[-4%] z-20 flex items-center justify-center w-12 h-12 rounded-full bg-zinc-900 border border-amber-500/40 text-amber-400 shadow-[0_0_15px_rgba(245,158,11,0.3)] hover:shadow-[0_0_25px_rgba(245,158,11,0.6)] hover:scale-110 hover:-translate-y-1 hover:text-white transition-all duration-300 animate-float-icon-slow group"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="absolute bottom-[6%] left-[4%] z-20 flex items-center justify-center w-12 h-12 rounded-full bg-zinc-900 border border-amber-500/40 text-amber-400 shadow-[0_0_15px_rgba(245,158,11,0.3)] hover:shadow-[0_0_25px_rgba(245,158,11,0.6)] hover:scale-110 hover:-translate-y-1 hover:text-white transition-all duration-300 animate-float-icon group"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="absolute bottom-[6%] right-[4%] z-20 flex items-center justify-center w-12 h-12 rounded-full bg-zinc-900 border border-amber-500/40 text-amber-400 shadow-[0_0_15px_rgba(245,158,11,0.3)] hover:shadow-[0_0_25px_rgba(245,158,11,0.6)] hover:scale-110 hover:-translate-y-1 hover:text-white transition-all duration-300 animate-float-icon-slow group"
            >
